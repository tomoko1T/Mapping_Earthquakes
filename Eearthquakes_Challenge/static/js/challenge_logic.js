...
// D1.2-1. Add a 3rd layer group for the major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEQ = new L.LayerGroup();

// D.1.2-2. Add a reference to the tectonic plates group to the overlays object.
let overlays = {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  /// D1-3(1) Create a style for the lines.
  let myStyle = {
    color: "#800000",
    weight: 3
}
